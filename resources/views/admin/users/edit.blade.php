    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="form-group d-none hidden">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="checkbox">
                    <label>
                        <input id="confirmed" checked="checked" type="checkbox" class="@if($errors->has('confirmed')) parsley-error @endif"
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="roles">Role</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
